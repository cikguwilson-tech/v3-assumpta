...
export const DrawerPanel: React.FC<DrawerPanelProps> = ({
  ...
  const isItemInBooklet = (id: string) =>
    bookletItems.some((item) => item.id === id);
      ...
      >
        ...
        >
                    ...
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <div className="flex items-center gap-1.5 shrink-0">
                        <button
                          ...
                          aria-label={
                            isExpanded
                              ? `Hide text for ${item.title}`
                              : `Read text for ${item.title}`
                          }
          ...
          {activeDrawer === "hymns" && (
            <div className="space-y-4 py-2">
              <p className="text-xs font-garamond italic text-[#5B6B85] pb-2 border-b border-[#A9C6E8]/30">
                Traditional Marian hymns appointed for the Solemnity of the
                Assumption
              </p>
                    ...
                    <div className="flex items-start justify-between gap-3">
                      <div className="flex-1">
                        <div
                          ...
                          style={{ fontSize: "var(--micro)" }}
                        >
                          {hymn.moment && <>{hymn.moment} &bull; </>}
                          MARIAN HYMN
                          {hymn.tune ? <> &bull; {hymn.tune}</> : null}
                        </div>
                      ...
                      <div className="flex items-center gap-1.5 shrink-0">
                        <button
                          ...
                          aria-label={
                            isExpanded
                              ? `Hide stanzas for ${hymn.title}`
                              : `View stanzas for ${hymn.title}`
                          }
                      ...
                      <div className="mt-3 p-3.5 bg-[#F8FAFD] border-l-2 border-[#1E4FA0] rounded-r space-y-3 font-garamond text-sm text-[#0B2C6B] animate-in fade-in duration-200">
                        {hymn.refrain && (
                          <div className="p-2.5 bg-white border border-[#E2EBF6] rounded-xs font-semibold italic text-xs text-[#0B2C6B]">
                            <span className="text-[#C9A227] not-italic mr-1.5 font-bold">
                              Refrain:
                            </span>
                            {hymn.refrain}
                          </div>
          ...
          {activeDrawer === "readings" && (
            <div className="space-y-4 py-2">
              <p className="text-xs font-garamond italic text-[#5B6B85] pb-2 border-b border-[#A9C6E8]/30">
                Theological and pastoral commentaries for contemplation on the
                Assumption
              </p>
                    ...
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <div className="flex items-center gap-1.5 shrink-0">
                        <button
                          ...
                          aria-label={
                            isExpanded
                              ? `Hide reflection ${reflection.title}`
                              : `Read reflection ${reflection.title}`
                          }
              ...
              {bookletItems.length === 0 ? (
                ...
                >
                  ...
                  <p className="font-garamond italic text-xs text-[#5B6B85] mt-1 max-w-xs">
                    Add antiphons, readings, hymns, or meditations from the
                    Liturgy and Hymns tabs to prepare for the Assumption feast.
                  </p>
                  <button
                    onClick={onAddAllToBooklet}
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between pb-2 border-b border-[#A9C6E8]/30">
                    ...
                    <button
                      onClick={() =>
                        bookletItems.forEach((it) => onRemoveFromBooklet(it.id))
                      }
          ...
          {activeDrawer === "booklet" ? (
            <div className="space-y-2">
              ...
              <p className="text-center font-garamond italic text-[11px] text-[#5B6B85]">
                Generates your personalized Mass attendance pass and saves your
                booklet
              </p>
            </div>
          ) : (
            <div className="text-center">
              ...
              >
                {PARISH_NAME} &copy; 2026 &mdash; Solemnity of the Assumption of
